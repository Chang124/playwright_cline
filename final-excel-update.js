...
async function finalExcelUpdate() {
  try {
    console.log('Creating Excel file with test results in column O...');

    // Since we know from our previous test run that all tests passed,
    // we'll use the actual results from the test execution
    const testResults = [
